 ...
 * @author plima
 */
public class frmUsuarioPesq extends javax.swing.JDialog {

    public int xcodigo;
    private UsuarioDAO daoUsuario;
    private DefaultTableModel modelo = null;

    public frmUsuarioPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1015, 571));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmUsuarioPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmUsuarioPesq dialog = new frmUsuarioPesq(new javax.swing.JFrame(), true);
    ...
    private void incluir() {
        frmUsuarioCad f = new frmUsuarioCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
        f.setVisible(true);
        pesquisar();
    }
    ...
    private void excluir() {
        if (Uteis.linhaSelecionada(tblResultado)) {
            try {
                daoUsuario.excluir(Integer.parseInt(tblResultado.getValueAt(tblResultado.getSelectedRow(), 0).toString()));
                pesquisar();
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "Erro ao excluir o registro/n: " + ex.toString());
            }
        }
    }
    ...
    private void alterarSenha() {
        if (Uteis.linhaSelecionada(tblResultado)) {
            frmUsuarioSenhaCad f = new frmUsuarioSenhaCad(null, rootPaneCheckingEnabled);
            f.xcodigo = Integer.parseInt(tblResultado.getValueAt(tblResultado.getSelectedRow(), 0).toString());
            f.setVisible(true);
            pesquisar();
        }
