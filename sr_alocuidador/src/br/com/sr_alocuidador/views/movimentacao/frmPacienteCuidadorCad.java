...
public class frmPacienteCuidadorCad extends javax.swing.JDialog {
     ...
     */
    public frmPacienteCuidadorCad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pnlDados.add(lblParentesco, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 20, -1, -1));

        cmbParentesco.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NÃO INFORMADO", "PAI", "MÃE", "FILHO(A)", "IRMÃO(Ã)", "AVÔ(Ó)", "NETO(A)", "TIO(A)", "SOBRINHO(A)", "BISAVÔ(Ó)", "SOBRINHO(A)-NETO(A)", "SOGRO(A)", "GENRO/NORA", "PADRASTO/MADRASTA", "ENTEADO(A)", "CUNHADO(A)", "OUTROS" }));
        pnlDados.add(cmbParentesco, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 40, 210, -1));
        ...
        pnlDados.add(lblSituacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 120, -1, -1));

        cmbSituacao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NÃO INFORMADO", "FORMAL", "INFORMAL" }));
        pnlDados.add(cmbSituacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 140, 210, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteCuidadorCad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteCuidadorCad dialog = new frmPacienteCuidadorCad(new javax.swing.JFrame(), true);
    ...
    private boolean validaDados(){
        ...
        else if (cmbParentesco.getSelectedIndex() == 0){
            JOptionPane.showMessageDialog(null, "Parentesco não informado");
            cmbParentesco.setFocusable(true);
            return false;
        }
        ...
        else if (cmbSituacao.getSelectedIndex() == 0){
            JOptionPane.showMessageDialog(null, "Situação não informado");
            cmbSituacao.setFocusable(true);
            return false;
        }
        else return true;
