 ...
 * @author plima
 */
public class frmPacienteInternacaoCad extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblDataIni.setText("Data Inicio:");
        getContentPane().add(lblDataIni, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, -1));
        getContentPane().add(txtDataIni, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 120, -1));

        lblDataFim.setText("Data Fim:");
        getContentPane().add(lblDataFim, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, -1, -1));
        getContentPane().add(txtDataFim, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 80, 130, -1));
        ...
        getContentPane().add(lblDiagnostico, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteInternacaoCad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteInternacaoCad dialog = new frmPacienteInternacaoCad(new javax.swing.JFrame(), true);
    ...
    private boolean validaDados(){
        ...
        if (cmbHospital.getSelectedIndex() < 0){
            ...
            return false;
        } else if ("".equals(txtDataIni.getText())){
            ...
            return false;
        } else if ("".equals(txtDiagnostico.getText())){
    ...
    private void gravar() throws SQLException{
        ...
        c.setIdmotivo(((ConstantesItem)cmbMotivo.getSelectedItem()));
        c.setDiagnostico(txtDiagnostico.getText());
        daoPacienteInternacao.validaDados(c);        
    }
    
    private void pesquisar() throws SQLException {
        PacienteInternacao c = daoPacienteInternacao.buscarPorId(xcodigo);
        if (c != null){
            ...
            txtDataIni.setText(Uteis.formatarData(c.getDataini()));
            txtDataFim.setText(Uteis.formatarData(c.getDatafim()));
            
            for(int i = 0; i < listaMotivo.size(); i++){
                if (listaMotivo.get(i).getIndice() == c.getIdmotivo().getIndice()){
    ...
    private void preencheHospital() throws SQLException {
        ...
        listaHospital = daoHospital.listarHospital("");
    ...
    private void preencheMotivo() throws SQLException{
        ...
        listaMotivo = daoConstanteItem.listarContantes(24);
