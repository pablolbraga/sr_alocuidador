 ...
 * @author plima
 */
public class frmPacienteVacinaPesq extends javax.swing.JDialog {

    public Paciente xpaciente;
    private PacienteVacinaDAO daoPacienteVacina;
    
    public frmPacienteVacinaPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Vacina", "Data", "Local", "Observação"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteVacinaPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteVacinaPesq dialog = new frmPacienteVacinaPesq(new javax.swing.JFrame(), true);
    ...
    private void pesquisar() throws SQLException {
        ...
        modelo.setNumRows(0);        
        for(PacienteVacina c : daoPacienteVacina.listarVacinasPorPaciente(xpaciente.getCodigo())){
    ...
    private void incluir(){
        frmPacienteVacinaCad f = new frmPacienteVacinaCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
    ...
    private void excluir(int codigo) throws SQLException{
        daoPacienteVacina.excluir(codigo);
    }
}
