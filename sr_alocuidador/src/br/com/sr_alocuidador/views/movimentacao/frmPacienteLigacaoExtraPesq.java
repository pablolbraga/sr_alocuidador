 ...
 * @author plima
 */
public class frmPacienteLigacaoExtraPesq extends javax.swing.JDialog {

    private LigacaoExtraDAO daoLigacaoExtra;
    public Paciente xpaciente;
    
    
    public frmPacienteLigacaoExtraPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Atendente", "Data", "Motivo", "Descrição", "Ligador"
            }
        ) {
        ...
        setSize(new java.awt.Dimension(1214, 482));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteLigacaoExtraPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteLigacaoExtraPesq dialog = new frmPacienteLigacaoExtraPesq(new javax.swing.JFrame(), true);
    ...
    private void pesquisar() throws SQLException {
        ...
        modelo.setNumRows(0);        
        for(LigacaoExtra c : daoLigacaoExtra.listarPorPaciente(xpaciente.getCodigo())){
    ...
    private void incluir(){
        frmPacienteLigacaoExtraCad f = new frmPacienteLigacaoExtraCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
    ...
    private void excluir(int codigo) throws SQLException{
        daoLigacaoExtra.excluir(codigo);
    }
}
