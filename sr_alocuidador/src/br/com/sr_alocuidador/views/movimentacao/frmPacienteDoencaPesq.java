...
public class frmPacienteDoencaPesq extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteDoencaPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteDoencaPesq dialog = new frmPacienteDoencaPesq(new javax.swing.JFrame(), true);
    ...
    private void pesquisar() throws SQLException {
        ...
        modelo.setNumRows(0);        
        for(PacienteDoenca c : daoPacienteDoenca.listarDoencasPorPaciente(xpaciente.getCodigo())){
    ...
    private void incluir(){
        frmPacienteDoencaCad f = new frmPacienteDoencaCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
