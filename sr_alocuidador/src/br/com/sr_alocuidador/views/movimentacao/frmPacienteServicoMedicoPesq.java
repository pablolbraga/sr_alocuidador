 ...
 * @author plima
 */
public class frmPacienteServicoMedicoPesq extends javax.swing.JDialog {

    public Paciente xpaciente;
    private PacienteServicoMedicoDAO daoPacienteServicoMedico;
    
    public frmPacienteServicoMedicoPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Vacina", "Data", "Profissional", "Observação"
            }
        ) {
        ...
        setSize(new java.awt.Dimension(1087, 482));
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro na pesquisa: " + ex.toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteServicoMedicoPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteServicoMedicoPesq dialog = new frmPacienteServicoMedicoPesq(new javax.swing.JFrame(), true);
    ...
    private void pesquisar() throws SQLException {
        ...
        modelo.setNumRows(0);        
        for(PacienteServicoMedico c : daoPacienteServicoMedico.listarServicosPorPaciente(xpaciente.getCodigo())){
    ...
    private void incluir(){
        frmPacienteServicoMedicoCad f = new frmPacienteServicoMedicoCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
    ...
    private void excluir(int codigo) throws SQLException{
        daoPacienteServicoMedico.excluir(codigo);
    }
}
