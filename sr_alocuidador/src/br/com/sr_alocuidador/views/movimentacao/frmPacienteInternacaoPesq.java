...
public class frmPacienteInternacaoPesq extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Hospital", "Data Inicio", "Data Fim", "Diagnóstico", "Motivo"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteInternacaoPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteInternacaoPesq dialog = new frmPacienteInternacaoPesq(new javax.swing.JFrame(), true);
    ...
    private void pesquisar() throws SQLException {
        ...
        modelo.setNumRows(0);        
        for(PacienteInternacao c : daoPacienteInternacao.listarConsultasPorPaciente(xpaciente.getCodigo())){
            modelo.addRow(new Object[]{
                c.getCodigo(),
                c.getHospital().getNome(),
                Uteis.formatarData(c.getDataini()),
                Uteis.formatarData(c.getDatafim()),
                c.getDiagnostico(),
                c.getIdmotivo().getNome()
            });
        }
    }
    
    private void incluir(){
        frmPacienteInternacaoCad f = new frmPacienteInternacaoCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
