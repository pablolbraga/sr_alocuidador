 ...
 * @author plima
 */
public class frmPacienteCirurgiaPesq extends javax.swing.JDialog {

    private PacienteCirurgiaDAO daoPacienteCirurgia;
    public Paciente xpaciente;
    
    
    public frmPacienteCirurgiaPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacienteCirurgiaPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPacienteCirurgiaPesq dialog = new frmPacienteCirurgiaPesq(new javax.swing.JFrame(), true);
    ...
    private void pesquisar() throws SQLException {
        ...
        modelo.setNumRows(0);        
        for(PacienteCirurgia c : daoPacienteCirurgia.listarServicosPorPaciente(xpaciente.getCodigo())){
            modelo.addRow(new Object[]{
                c.getCodigo(),
                c.getDescricao(),
                "A".equals(c.getTipo()) ? "ANTIGA" : "R".equals(c.getTipo()) ? "RECENTE" : "NÃO INFORMADO"
            });
        }
    }
    
    private void incluir(){
        frmPacienteCirurgiaCad f = new frmPacienteCirurgiaCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
    ...
    private void excluir(int codigo) throws SQLException{
        daoPacienteCirurgia.excluir(codigo);
    }
}
