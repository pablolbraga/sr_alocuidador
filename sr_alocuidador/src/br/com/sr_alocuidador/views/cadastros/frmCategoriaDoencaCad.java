...
public class frmCategoriaDoencaCad extends javax.swing.JDialog {
     ...
     */
    public frmCategoriaDoencaCad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnGravar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 90, 30));

        setSize(new java.awt.Dimension(534, 185));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCategoriaDoencaCad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmCategoriaDoencaCad dialog = new frmCategoriaDoencaCad(new javax.swing.JFrame(), true);
    ...
    private void gravar(){
        CategoriaDoenca categoriaDoenca = new CategoriaDoenca();
