...
public class frmHospitalPesq extends javax.swing.JDialog {
     ...
     */
    public frmHospitalPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmHospitalPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmHospitalPesq dialog = new frmHospitalPesq(new javax.swing.JFrame(), true);
    ...
    private void alterar() {
        if (!Uteis.linhaSelecionada(tblResultado)){
            ...
            frmHospitalCad f = new frmHospitalCad(null, rootPaneCheckingEnabled);
