 ...
 * @author plima
 */
public class frmPerguntaItemAlertaPesq extends javax.swing.JDialog {

    private PerguntaItemAlertaDAO daoPerguntaItemAlerta;
    public PerguntaItem xpergitem;
    
    public frmPerguntaItemAlertaPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPerguntaItemAlertaPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPerguntaItemAlertaPesq dialog = new frmPerguntaItemAlertaPesq(new javax.swing.JFrame(), true);
    ...
    private void pesquisar() throws SQLException {
        ...
        modelo.setNumRows(0);
        for(PerguntaItemAlerta p : daoPerguntaItemAlerta.listarAlertasPorItem(xpergitem.getCodigo())){
            modelo.addRow(new Object[]{ p.getCodigo(), p.getNome() });
        }
    ...
    private void incluir() throws SQLException{
        ...
        frmPerguntaItemAlertaCad f = new frmPerguntaItemAlertaCad(null, rootPaneCheckingEnabled);
        f.xcodigo = 0;
        f.xpergitem = xpergitem;
    ...
    private void excluir() throws SQLException{
        ...
        if (Uteis.linhaSelecionada(tblResultado)){
            daoPerguntaItemAlerta.excluir(Integer.parseInt(tblResultado.getValueAt(tblResultado.getSelectedRow(), 0).toString()));
            pesquisar();
        }
