 ...
 * @author plima
 */
public class frmConvenioPesq extends javax.swing.JDialog {

    private ConvenioDAO convenioDao;
    private DefaultTableModel modelo = null;
    
    /**
     * Creates new form frmConvenioPesq
     */
    public frmConvenioPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConvenioPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConvenioPesq dialog = new frmConvenioPesq(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            if (lista.size() > 0){
                ...
                for(int i = 0; i < lista.size(); i++){
                    modelo.addRow(new Object[]{lista.get(i).getCodigo(), lista.get(i).getNomefantasia(), lista.get(i).getCnpj()});
                }
            }
    ...
    private void alterar() {
        if (!Uteis.linhaSelecionada(tblResultado)){
            ...
            frmConvenioCad f = new frmConvenioCad(null, rootPaneCheckingEnabled);
    ...
    private void excluir() {
        if (Uteis.linhaSelecionada(tblResultado)){
            try {
                convenioDao.Excluir(Integer.parseInt(tblResultado.getValueAt(tblResultado.getSelectedRow(), 0).toString()));
                pesquisar();
            } catch (SQLException ex) {
