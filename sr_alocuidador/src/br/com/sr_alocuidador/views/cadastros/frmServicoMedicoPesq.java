...
public class frmServicoMedicoPesq extends javax.swing.JDialog {
     ...
     */
    public frmServicoMedicoPesq(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmServicoMedicoPesq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmServicoMedicoPesq dialog = new frmServicoMedicoPesq(new javax.swing.JFrame(), true);
    ...
    private void alterar() {
        if (!Uteis.linhaSelecionada(tblResultado)){
            ...
            frmServicoMedicoCad f = new frmServicoMedicoCad(null, rootPaneCheckingEnabled);
